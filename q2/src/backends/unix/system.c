...
Sys_GetGameAPI(void *parms)
{
	...
	char * gamename;
	#ifdef __ARM_NEON__
	gamename = "game_neon.so";
	if (strstr(game,"xatrix"))
	gamename = "game_xatrix_neon.so";
	if (strstr(game,"zaero"))
	gamename = "game_zaero_neon.so";
	if (strstr(game,"rogue"))
	gamename = "game_rogue_neon.so";
	if (strstr(game,"ctf"))
	gamename = "game_ctf_neon.so";
	#else
	gamename = "game.so";
	if (strstr(game,"xatrix"))
	gamename = "game_xatrix.so";
	if (strstr(game,"zaero"))
	gamename = "game_zaero.so";
	if (strstr(game,"rogue"))
	gamename = "game_rogue.so";
	if (strstr(game,"ctf"))
	gamename = "game_ctf.so";
	#endif
	...
	//while (1)
	{
		path = "/""d""a""t""a""/""d""a""t""a""/""c""o""m"".""n""0""n""3""m""4"".""Q""I""I""4""A""/""l""i""b";//FS_NextPath(path);
